    ...
    public static void main(String[] args) {
        try {
            ...
            sql = "CREATE TABLE favorite_records ("
                    + "user_id VARCHAR(255) NOT NULL," // char[] array = new char[255]
                    + "item_id VARCHAR(255) NOT NULL," // Why not 256? 额外一个byte记录长度
            ...
            statement.executeUpdate(sql); // Above, why is the password so long? This is the encrypted code!
